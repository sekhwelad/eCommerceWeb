...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe(
      'pk_test_51NgOeZImNQuH01R1HKohZ1X1EUBa00nKdjTuN553ss9f7ZsZerUpQY6RLLTbXqbRs9MzPAis2W07mqaYEpOCtMfJ00qWkFSFPh'
    ).then((stripe) => {
      this.stripe = stripe;
  ...
  private async confirmPaymentWithStripe(basket: Basket | null) {
    ...
    if (!result) throw new Error('Prob;em attempting payment with stripe');
